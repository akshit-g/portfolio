            ...
            >
                <div className="w-full">
                    ...
                    <p className="text-justify lg:leading-7 text-foreground/80 lg:text-start mt-10">
                        A creative problem solver with over 2 years of programming experience, I&apos;ve explored diverse programming languages, libraries, and technology stacks, honing my skills in Cybersecurity, UI/UX, and building ML apps.
                    </p>
