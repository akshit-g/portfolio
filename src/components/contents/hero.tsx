                ...
                <>
                    ...
                    <div className="text-balance relative z-20 mx-auto my-4 max-w-5xl text-center text-4xl lg:text-5xl font-bold">
                        <motion.h2 className="text-balance !leading-snug">
                            {"Crafting Intelligent Solutions where Data Insight meets Digital"
                                .split(" ")
                                .map((word, index) => (
                                    <motion.span
                                    ...
                                    >
                                        {word === "Digital" ? (
                                            <span className="text-transparent bg-clip-text bg-gradient-to-br from-sky-500 to-blue-500">Digital Security</span>
                                        ) : word}
                                        &nbsp;
                                        {word === "where" && <br />}
                                    </motion.span>
